              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Zonas   <button class="btn btn-success" 
                    ...
                    <div class="panel-body table-responsive" style="height: 400px;" 
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          col-xs-12">
                            <label>Poblado:</label>
                            <input type="text" class="form-control" name="poblado" id="poblado"
                             maxlength="50" placeholder="Poblado" required >
                          </div>
